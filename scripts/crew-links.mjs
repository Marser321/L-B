...
//   CREW_LINK_SECRET=… PUBLIC_APP_URL=https://l-b-lyart.vercel.app node scripts/crew-links.mjs
...
const baseUrl = process.argv[2] || process.env.PUBLIC_APP_URL || 'https://l-b-lyart.vercel.app';
